        ...
        <div class="row">
          <div class="col-lg-4 col-8">
            ...
            <div class="small-box bg-success">
              ...
              <a href="page/industrial_supervisor.php" class="nav-link">Industrial<i class="fas fa-arrow-circle-right"></i></a>
          ...
          <div class="col-lg-4 col-8">
           ...
           <h3><?php echo $count_supervisor; ?></h3>
              ...
              <a href="page/institution_supervisor.php" class="nav-link">Instituition <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-8">
           ...
           <h3><?php echo $count_students; ?></h3>
              ...
              <a href="page/students.php" class="nav-link">Students <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
